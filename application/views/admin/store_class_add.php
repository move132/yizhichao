...
<div class="uio-shop-box">
	<form class="form-horizontal" id="area_add" action="" onsubmit="javascript:return false;">
		...
		<div class="form-group">
			<label for="name" class="col-md-2 control-label">类型名称：</label>
			<div class="col-sm-10">
				<div class="col-sm-8">
					<input type="text" class="form-control" id="name" name="name" placeholder="店铺类型名称" />
				</div>
		...
		<div class="form-group">
			<label for="remark" class="col-md-2 control-label">类型备注：</label>
			<div class="col-sm-10">
				<div class="col-sm-8">
					<input type="text" class="form-control" id="remark" name="remark" placeholder="类型备注说明" />
				</div>
			</div>
		</div>		
		<div class="form-group">
...
$(function(){
	$("form#area_add").validate({ 
		...
		messages: {
			name: {
				required: "<i class='icon-exclamation-sign'></i>店铺类型名称不能为空",
			}
		}
	});
});
