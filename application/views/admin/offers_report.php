...
<div class="mark-list">
	...
	<div id="ECharts_num" style="width: 100%;height:350px;"></div>
			...
			<tbody>
				<?php if(isset($item)){foreach ($item as $v){?>
					<tr>
						...
						<td ><?php echo $v['store_total']?></td>
						<td ><?php echo $v['agent_num']?></td>
						<td ><?php echo $v['agent_total']?></td>
						<td ><?php echo $v['promoter_num']?></td>
						<td ><?php echo $v['promoter_total']?></td>
					</tr>
				<?php }}?>
...
<script type="text/javascript">
    	    ...
    	    series : [
    	        {
    	            name:'商铺',
    	            type:'line',
    	            data:[<?php echo $yAxis_store_total?>],
    	            markLine : {
    	                data : [
    	        ...
    	        },
    	        {
    	            name:'代理',
    	            type:'line',
    	            data:[<?php echo $yAxis_agent_total?>],
    	            markLine : {
    	                data : [
    	                    {type : 'average', name : '平均值'}
    	                ]
    	        ...
    	        },
    	        {
    	            name:'推广',
    	            type:'line',
    	            data:[<?php echo $yAxis_promoter_total?>],
    	            markLine : {
    	                data : [
    	                    {type : 'average', name : '平均值'}
    	                ]
    ...
    var myChart_num = echarts.init(document.getElementById('ECharts_num'));
	// 指定图表的配置项和数据
    var option_num = {
    	    title : {
    	        text: '趋势图（提现次数）',
    	    ...
    	    series : [
    	        ...
    	        },
    	        {
    	            name:'推广',
    	            type:'line',
    	            data:[<?php echo $yAxis_promoter_num?>],
    	            markLine : {
    	                data : [
    	                    {type : 'average', name : '平均值'}
    	                ]
