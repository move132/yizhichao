...
<div class="uio-shop-box">
	<form class="form-horizontal" id="area_add" action="" onsubmit="javascript:return false;">
		...
		<div class="form-group">
			<label for="class_name" class="col-md-2 control-label">类目名称：</label>
			<div class="col-sm-10">
				<div class="col-sm-8">
					<input type="text" class="form-control" id="class_name" name="class_name" placeholder="类目名称：" />
				</div>
...
$(function(){
	$("form#area_add").validate({ 
		...
		messages: {
			class_name: {
				required: "<i class='icon-exclamation-sign'></i>类目名称不能为空",
			}
		}
	});
});
